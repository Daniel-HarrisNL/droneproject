...
def send_fly_up_command_to_socket(soc, cm, send_command_to_socket=send_command_to_socket, cm_out_of_range_error = CM_OUT_OF_RANGE_VALUE_ERROR):
...
def send_fly_down_command_to_socket(soc, cm, send_command_to_socket=send_command_to_socket, cm_out_of_range_error = CM_OUT_OF_RANGE_VALUE_ERROR):
    if not fly_cm_in_bounds(cm):
        raise cm_out_of_range_error
...
def send_fly_left_command_to_socket(soc, cm, send_command_to_socket=send_command_to_socket, cm_out_of_range_error = CM_OUT_OF_RANGE_VALUE_ERROR):
    if not fly_cm_in_bounds(cm):
        raise cm_out_of_range_error
    return send_command_to_socket(soc, LEFT_COMMAND_FORMAT_STRING.format(cm))

RIGHT_COMMAND_FORMAT_STRING = 'right {0}'
def send_fly_right_command_to_socket(soc, cm, send_command_to_socket=send_command_to_socket, cm_out_of_range_error = CM_OUT_OF_RANGE_VALUE_ERROR):
    if not fly_cm_in_bounds(cm):
        raise cm_out_of_range_error
    return send_command_to_socket(soc, RIGHT_COMMAND_FORMAT_STRING.format(cm))
    
FORWARD_COMMAND_FORMAT_STRING = 'forward {0}'
def send_fly_forward_command_to_socket(soc, cm, send_command_to_socket=send_command_to_socket, cm_out_of_range_error = CM_OUT_OF_RANGE_VALUE_ERROR):
    if not fly_cm_in_bounds(cm):
        raise cm_out_of_range_error
...
def send_fly_backward_command_to_socket(soc, cm, send_command_to_socket=send_command_to_socket, cm_out_of_range_error = CM_OUT_OF_RANGE_VALUE_ERROR):
    if not fly_cm_in_bounds(cm):
        raise cm_out_of_range_error
...
def send_rotate_clockwise_command_to_socket(soc, degrees, send_command_to_socket=send_command_to_socket, rotate_degrees_out_of_range_error = ROTATE_DEGREES_OUT_OF_RANGE_VALUE_ERROR):
...
def send_rotate_counterclockwise_command_to_socket(soc, degrees, send_command_to_socket=send_command_to_socket, rotate_degrees_out_of_range_error = ROTATE_DEGREES_OUT_OF_RANGE_VALUE_ERROR):
    if not rotate_degrees_in_bounds(degrees) :
        raise rotate_degrees_out_of_range_error
...
def send_set_speed_command_to_socket(soc, speed_cm_per_second, send_command_to_socket=send_command_to_socket, invalid_speed_error = INVALID_SPEED_VALUE_ERROR):
...
FLIP_INVALID_DIRECTION_VALUE_ERROR = ValueError("Invalid direction specified for flip. Must be either a string 'l', 'r', 'f', 'b', or FlipDirection.LEFT, FlipDirection.RIGHT, FlipDirection.FORWARD, FlipDirection.BACK from the FlipDirection Enum.")
...
def valid_direction(direction):
    return direction in [FLIP_DIRECTION_LEFT_STRING, FLIP_DIRECTION_RIGHT_STRING, FLIP_DIRECTION_FORWARD_STRING, FLIP_DIRECTION_BACK_STRING, FlipDirection.LEFT, FlipDirection.RIGHT, FlipDirection.FORWARD, FlipDirection.BACK]
...
def send_flip_command_to_socket(soc, direction, send_command_to_socket=send_command_to_socket, invalid_direction_error = FLIP_INVALID_DIRECTION_VALUE_ERROR):
